...
;(function(){
	...
	/*	$scope.loadAdvert=function(){
		...
		function loadNavData(){
			...
			$scope.actions={
				topSet:true,//置顶设置
				topSetUrl:"/page/"+ArtJS.server.language+"/edit/stick.html",//置顶设置链接
				boutiqueLib:true,//精品库
				boutiqueLibUrl:"/page/"+ArtJS.server.language+"/edit/exquisite.html",//精品库链接
				noedit:true,//查看所有未处理数据
				noeditUrl:"/page/"+ArtJS.server.language+"/edit/chief/untreatedPic.html",//查看所有未处理数据链接
