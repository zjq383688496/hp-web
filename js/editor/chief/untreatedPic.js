...
;(function(){
	...
	$timeout(function () {
		...
		$scope.normalEditorCondition={
			parentUserId:""//【不传】：默认查询当前登录账号下的副主编【0】：查询所有下下家的小编 用户ID，当前用户下面的用户小编
		};//查询小编接口
		//小编页相关 国际化
		...
		$scope.navSelector={
			...
			subEditorList:[{"userId":0,"nickName":"全部副主编"}],//副主编列表
			// normalSelector:true,//小编展示
			normalSelector2:true,//小编展示
			// subSelector:true,//副主编展示
			subSelector2:true//副主编展示
		...
		//【0】：查询所有下下家的小编
		$scope.normalEditorCondition.parentUserId=0;
